...
Actualmente enfocado en el desarrollo web con conocimientos en tecnologías como **HTML, CSS, JavaScript, React JS, Redux, Bootstrap 5, NodeJS, SQL,Python, Flask Git** entre otras, para el desarrollo de páginas y aplicaciones web.
